...
var $author$project$Main$GotGames = function (a) {
	return {$: 'GotGames', a: a};
};
...
var $author$project$Main$Game = F6(
	function (moveHistory, gameStrategy, id, currentPins, currentActor, gameFinished) {
		return {currentActor: currentActor, currentPins: currentPins, gameFinished: gameFinished, gameStrategy: gameStrategy, id: id, moveHistory: moveHistory};
	});
var $author$project$Main$Computer = {$: 'Computer'};
var $author$project$Main$Player = {$: 'Player'};
var $author$project$Main$actorFromString = function (str) {
	switch (str) {
		case 'PLAYER':
			return $elm$core$Maybe$Just($author$project$Main$Player);
		case 'COMPUTER':
			return $elm$core$Maybe$Just($author$project$Main$Computer);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Main$actorDecoder = function () {
	var failMsg = function (str) {
		return $elm$json$Json$Decode$fail('Could not parser actor from ' + str);
	};
	var strDecode = function (str) {
		return A2(
			...
			A2(
				...
				$author$project$Main$actorFromString(str)));
	};
	return A2($elm$json$Json$Decode$andThen, strDecode, $elm$json$Json$Decode$string);
}();
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Main$Random = {$: 'Random'};
var $author$project$Main$Smart = {$: 'Smart'};
var $author$project$Main$gameStrategyFromString = function (str) {
	switch (str) {
		case 'RandomPick':
			return $elm$core$Maybe$Just($author$project$Main$Random);
		case 'SmartPick':
			return $elm$core$Maybe$Just($author$project$Main$Smart);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Main$gameStrategyDecoder = function () {
	var failMsg = function (str) {
		return $elm$json$Json$Decode$fail('Could not parser game strategy from ' + str);
	};
	var decodeStr = function (str) {
		return A2(
			...
			A2(
				$elm$core$Maybe$map,
				$elm$json$Json$Decode$succeed,
				$author$project$Main$gameStrategyFromString(str)));
	};
	return A2($elm$json$Json$Decode$andThen, decodeStr, $elm$json$Json$Decode$string);
}();
var $author$project$Main$Move = F2(
	function (pinsTaken, actor) {
		return {actor: actor, pinsTaken: pinsTaken};
	});
...
var $author$project$Main$moveDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'actor',
	$author$project$Main$actorDecoder,
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'pinsTaken',
		$elm$json$Json$Decode$int,
		$elm$json$Json$Decode$succeed($author$project$Main$Move)));
var $author$project$Main$moveHistoryDecoder = $elm$json$Json$Decode$list($author$project$Main$moveDecoder);
...
var $author$project$Main$gameDecoder = A3(
	...
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'currentActor',
		$elm$json$Json$Decode$nullable($author$project$Main$actorDecoder),
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'currentPins',
			$elm$json$Json$Decode$int,
			A3(
				...
				A3(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
					'gameStrategy',
					$author$project$Main$gameStrategyDecoder,
					A3(
						$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'moveHistory',
						$author$project$Main$moveHistoryDecoder,
						$elm$json$Json$Decode$succeed($author$project$Main$Game)))))));
var $author$project$Main$gamesDecoder = $elm$json$Json$Decode$list($author$project$Main$gameDecoder);
...
var $author$project$Main$getGames = function (baseUrl) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotGames, $author$project$Main$gamesDecoder),
...
var $author$project$Main$init = function (backendBaseUrl) {
	var model = $author$project$Main$initialModel(backendBaseUrl);
	var cmd = $author$project$Main$getGames(model.backendUrl);
...
var $author$project$Main$SingleGame = function (a) {
	return {$: 'SingleGame', a: a};
};
var $author$project$Main$GameDeleted = function (a) {
...
var $author$project$Main$deleteGame = F2(
	function (baseUrl, id) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$emptyBody,
				expect: $elm$http$Http$expectWhatever($author$project$Main$GameDeleted),
				headers: _List_Nil,
				method: 'DELETE',
...
var $author$project$Main$getGame = F2(
	function (baseUrl, id) {
		return $elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Main$GotGame, $author$project$Main$gameDecoder),
				url: baseUrl + ('/nim-games/' + id)
			});
	});
...
var $author$project$Main$GotMove = F2(
	function (a, b) {
		return {$: 'GotMove', a: a, b: b};
	});
...
var $author$project$Main$actorToString = function (actor) {
	if (actor.$ === 'Player') {
		return 'PLAYER';
	} else {
		return 'COMPUTER';
...
var $author$project$Main$moveEncoder = function (move) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'pinsTaken',
				$elm$json$Json$Encode$int(move.pinsTaken)),
				_Utils_Tuple2(
				'actor',
				$elm$json$Json$Encode$string(
					$author$project$Main$actorToString(move.actor)))
			]));
};
...
var $author$project$Main$makeMove = F3(
	function (baseUrl, id, move) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Main$moveEncoder(move)),
				expect: A2(
					$elm$http$Http$expectJson,
					$author$project$Main$GotMove(id),
					$author$project$Main$moveDecoder),
				url: baseUrl + ('/moves?gid=' + id)
			});
	});
var $author$project$Main$starteGame = F2(
	function (baseUrl, strategy) {
		var gs = function () {
			if (strategy.$ === 'Random') {
				return 'rnd';
			} else {
	...
	function (msg, model) {
		switch (msg.$) {
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								problems: _List_Nil,
								view: $author$project$Main$SingleGame(game)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = msg.a.a;
			...
			case 'MakeMove':
				...
				return _Utils_Tuple2(
					model,
					A3($author$project$Main$makeMove, model.backendUrl, id, move));
			case 'GotMove':
				if (msg.b.$ === 'Ok') {
					var id = msg.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{problems: _List_Nil}),
						A2($author$project$Main$getGame, model.backendUrl, id));
				} else {
					var error = msg.b.a;
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Main$gameStrategyToString = function (strategy) {
	if (strategy.$ === 'Random') {
		return 'RandomPick';
	} else {
		return 'SmartPick';
...
var $author$project$Main$viewMove = function (move) {
	return A2(
		$elm$html$Html$td,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$text(
						$elm$core$String$fromInt(move.pinsTaken)),
						A2(
						$elm$html$Html$h3,
						_List_Nil,
						_List_fromArray(
...
var $author$project$Main$viewMoves = function (moves) {
	var renderMoves = $elm$core$List$isEmpty(moves) ? _List_fromArray(
		[
			A2(
			$elm$html$Html$td,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('no moves yet')
				]))
		]) : A2($elm$core$List$map, $author$project$Main$viewMove, moves);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$tr, _List_Nil, renderMoves)
					]))
			]));
};
			...
			[
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Current Actor')
													]))
											])),
										A2(
										$elm$html$Html$td,
										...
										_List_fromArray(
											[
												...
												A2(
													$elm$core$Maybe$withDefault,
													'no Actor yet',
													A2($elm$core$Maybe$map, $author$project$Main$actorToString, game.currentActor)))
											]))
									])),
								A2(
								$elm$html$Html$tr,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$text('Current Pins')
													]))
											])),
										A2(
										$elm$html$Html$td,
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$elm$core$String$fromInt(game.currentPins))
											]))
									])),
								A2(
								$elm$html$Html$tr,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$author$project$Main$gameStrategyToString(game.gameStrategy))
											]))
									]))
							]))
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Move History')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
				...
				$author$project$Main$viewMoves(game.moveHistory),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('columns is-mobile is-centered')
					]),
				_List_fromArray(
					[
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										A2(
											$author$project$Main$MakeMove,
											A2($author$project$Main$Move, 1, $author$project$Main$Player),
											game.id)),
										A2(isDisabled, 1, game.currentPins)
									]),
								_List_fromArray(
									[
							...
							[
								...
								_List_fromArray(
									[
										...
										A2(
											$author$project$Main$MakeMove,
											A2($author$project$Main$Move, 2, $author$project$Main$Player),
											game.id)),
										A2(isDisabled, 2, game.currentPins)
									]),
								_List_fromArray(
									[
							...
							[
								...
								_List_fromArray(
									[
										...
										A2(
											$author$project$Main$MakeMove,
											A2($author$project$Main$Move, 3, $author$project$Main$Player),
											game.id)),
										A2(isDisabled, 3, game.currentPins)
									]),
								_List_fromArray(
									[
...
var $author$project$Main$SwitchViewTo = function (a) {
	return {$: 'SwitchViewTo', a: a};
};
...
var $author$project$Main$viewGameRow = function (game) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Main$boolToString(game.gameFinished))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				...
				_List_fromArray(
					[
								...
								_List_fromArray(
									[
										...
										$author$project$Main$SwitchViewTo(
											$author$project$Main$SingleGame(game))),
										$elm$html$Html$Attributes$alt('View')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('fas fa-list')
											]),
										_List_Nil)
									]))
							])),
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('icon has-text-danger')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick(
										$author$project$Main$DeleteGame(game.id))
									]),
								_List_fromArray(
									[
										A2(
...
var $author$project$Main$viewBreadcrumb = A2(
	$elm$html$Html$nav,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('breadcrumb is-right')
		]),
	_List_fromArray(
		[
			A2(
...
var $author$project$Main$ClearProblems = {$: 'ClearProblems'};
var $author$project$Main$viewProblem = function (problem) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$Main$ClearProblems)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$strong,
...
var $author$project$Main$viewProblems = function (problems) {
	return A2($elm$core$List$map, $author$project$Main$viewProblem, problems);
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Coding Assesment')
									])),
								$author$project$Main$viewBreadcrumb,
								$author$project$Main$renderView(model.view)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('container is-size-1-mobile')
							]),
						$author$project$Main$viewProblems(model.problems))
					]))
			]),
		title: 'Nim Game'
	};
